...
<body>
    <form method="post" action="./add-article.php" class="container my-5">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="id_article_categorie" name="id_article_categorie">
                <option value="">1</option>
            </select>
        </div>
        <div class="form-group">
            <label for="article_photo">Example file input</label>
            <input type="file" class="form-control-file" id="article_photo" name="article_photo">
        </div>
        <div class="form-group">
            <label for="article_contenu">Contenu article</label>
            <textarea class="form-control" id="article_contenu" rows="3" name="article_contenu"></textarea>
        </div>
